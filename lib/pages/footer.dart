      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          NavigationDestination(
            icon: Icon(CustomIcons.bookchoose, color: Color.fromRGBO(242, 241, 229, 1), size: 30,),
            label: "",
          ),
          NavigationDestination(
            icon: Icon(CustomIcons.list, color: Color.fromRGBO(242, 241, 229, 1), size: 30,),
            label: "",
          ),
          NavigationDestination(
            icon: Icon(CustomIcons.statistic, color: Color.fromRGBO(242, 241, 229, 1), size: 30,),
            label: "",
          ),
          NavigationDestination(
            icon: Icon(CustomIcons.communty, color: Color.fromRGBO(242, 241, 229, 1), size: 30,),
            label: "",
          ),
          NavigationDestination(
            icon: Icon(CustomIcons.person, color: Color.fromRGBO(242, 241, 229, 1), size: 30,),
            label: "",
          ),
        ],
      ),
